describe("App Homepage - Title and Error Handling Tests", () => {
    it("should have the correct title", () => {
        cy.visit("http://localhost:3000/app.html");
...
describe("App Homepage - Main Content Display Tests", () => {
    ...
    it("should display the test element with correct text", () => {
        ...
        cy.get("#my-element").should("have.text", "This is a test element.");
    });
